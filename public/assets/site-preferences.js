(function () {
  ...
  const exact = new Map(Object.entries({
    '智拓客':'LeadPilot','概览':'Overview','获客大盘':'Lead Dashboard','获客 · 找客户':'Lead Generation','邮件获客':'Email Outreach','SGO 独立站获客':'SGO Website Leads','海关数据':'Customs Data','社媒自动发帖':'Social Auto-posting','转化工具':'Conversion Tools','获客工作台':'Lead Workspace','报价自动化':'Quote Automation','AI 客服':'AI Support','任务管理':'Task Management','免费工具':'Free Tools','DNS 记录生成器':'DNS Record Generator','Spam 敏感词检查':'Spam Word Checker','账户':'Account','个人中心':'Profile','定价 / 套餐':'Pricing / Plans','设置':'Settings','管理员':'Administrator','开发中':'Coming Soon','已上线':'Live',
