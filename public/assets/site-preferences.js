(function () {
  ...
  const exact = new Map(Object.entries({
    ...
    '选择方式':'Choose Method','搜索配置':'Search Setup','筛选结果':'Filter Results','AI 筛选':'AI Filter','选择数据源':'Choose Data Source','即将上线':'Coming Soon','请选择国家':'Select Country','请选择城市':'Select City','请先选择国家':'Select a country first','请先选择国家，再选择城市':'Select a country first, then choose a city',
